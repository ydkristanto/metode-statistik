...
format:
  html:
    ...
    keywords: "eksperimen, eksperimen semu, eksperimen kuasi, pemodelan, normalitas, Shapiro-Wilk, uji t, ANCOVA, analysis of covariance, Welch, R"
    page-layout: article
    code-fold: true
    code-tools: true

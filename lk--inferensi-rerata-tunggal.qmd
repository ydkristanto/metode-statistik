...
Dengan demikian, derajat bebasnya adalah $df = 25 - 1 = 24$. Distribusi sampling tersebut ditunjukkan pada @fig-dist-sampling-tkda.
...
Seorang peneliti merekrut sampel acak berukuran *n* = 40 orang untuk berpartisipasi dalam penelitian tentang intervensi depresi. Peneliti mengukur tingkat depresi peserta sebelum penelitian hasilnya tercatat dalam `sampel_depresi`. Berdasarkan data tersebut, peneliti tersebut mednuga bahwa skor depresi sampelnya lebih rendah dibandingkan skor depresi populasi 'normal', yaitu sebesar 4,0. Dengan menggunakan tingkat signifikansi $\alpha = \text{0,05}$, ujilah dugaan peneliti tersebut!

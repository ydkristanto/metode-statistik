...
df2_pemain_bola <- n_pemain_bola - k_pemain_bola
...
hasil_anova_pemain_bola <- sampel_pemain_bola %>% 
  anova_test(formula = tinggi_badan ~ posisi)
hasil_anova_pemain_bola %>% 
  kbl(linesep = "",
      booktabs = TRUE) %>% 
  kable_styling(latex_options = c("striped",
                                  "condensed"),
...
hasil_tukey_pemain_bola <- sampel_pemain_bola %>% 
  tukey_hsd(formula = tinggi_badan ~ posisi)
hasil_tukey_pemain_bola %>% 
